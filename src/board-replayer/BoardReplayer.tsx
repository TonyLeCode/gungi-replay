		...
		<main className='flex flex-col items-center'>
			...
			<div className='flex items-center mb-12 gap-8'>
				...
				<div className='flex items-center gap-2'>
					<button className='bg-amber-500 hover:bg-amber-400 active:bg-amber-600 rounded px-4 py-1'>stop</button>
					<button className='bg-amber-500 hover:bg-amber-400 active:bg-amber-600 rounded px-4 py-1'>autoplay</button>
					<input className='bg-slate-300 px-3 py-1 w-24' type='number' value={1000} /> ms
				</div>
			</div>
